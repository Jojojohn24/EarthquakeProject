...
if __name__ == '__main__':
    ...
    upload_success = cloud_storage_uploader.upload_data_to_bucket_bronze_layer(config.daily_url)
    if upload_success:
    ...
    print(f"Data loaded to BigQuery table {config.dataset_id}.{config.table_id} successfully.")
